...
STEP_TIME = 3  # time between steps (interactions with forms): 0.5 seconds
...
def get_driver():
    if LOCAL_USE:
        dr = webdriver.Chrome(
            "/Users/carlossanchez/Downloads/visa_rescheduler/l1/chromedriver")
    else:
...
def login():
    ...
    print("Login start...")
    href = driver.find_element(By.XPATH, '//div[@class="homeContinueBg"]').find_element(By.XPATH, './..')
    href.click()
    time.sleep(STEP_TIME)
